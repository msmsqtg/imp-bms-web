<template>
  <div class="login-config">
    ...
    <el-form :model="uiConfig" label-width="120px">
      <el-form-item label="登录页面设置">
        <el-input type="textarea" v-model="uiConfig.login_setting" placeholder="登录页面视觉设置" :disabled="isViewMode"></el-input>
      </el-form-item>
      <el-form-item label="登录表单字段">
        <el-input type="textarea" v-model="form.login_form" placeholder="登陆表单字段定义" :disabled="isViewMode"></el-input>
      </el-form-item>
      <el-form-item>
      ...
      if (this.form.login_form) {
        try {
          ...
          const res: any = await baseService.post(baseUrl, {
            ...
            login_form: this.form.login_form
          });
          if (res.code !== '00000') {
